    ...
    <div class="mainHome">
        <div class="lado1">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="NuevoTecnicoMantenimiento" class="active">Insertar nuevo tecnico de mantenimiento</a>
                    </li>
        ...
        <div class="lado2">
            ...
            <div class="container-texto">
                <p class="titulo1">Insertar Nuevo tecnico de mantenimiento</p>
                ...
                <form action="" method="post" class="form-proveedor">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Escoger maquina a reparar</option>
                        <option value="1">Maquina 1 - modelo</option>
                        <option value="2">Maquina 2 - modelo</option>
                        <option value="3">Maquina 3 - modelo</option>
                    </select>
