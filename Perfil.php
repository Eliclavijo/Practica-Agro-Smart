    ...
    <div class="mainHome">
        <div class="lado1">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="perfil.php" class="active">Perfil e inventario</a></li>
        ...
        <div class="lado2">
            ...
            <div class="container-texto">
                ...
                <p class="subtitulo1">Datos del usuario</p>
                <div class="datos">
                    <p>Nombre completo: aaaaaaaa<span></span></p>
                    <p>Cedula: 00000000<span></span></p>
                    <p>Direccion: aaaaaaaaa <span></span></p>
                    <p>Telefono: 000000<span></span></p>
                    <p>Correo: aaaaa@aaa.com<span></span></p>
                </div>
                <p class="subtitulo1">Datos de la empresa</p>
                <div class="datos">
                    <p>Nombre completo: aaaaaaaa<span></span></p>
                    <p>Nit: 00000000<span></span></p>
                    <p>Direccion: aaaaaaaaa <span></span></p>
                    <p>Telefono: 000000<span></span></p>
                </div>
                <br />
                <p class="titulo1">Inventario de Maquinaria</p>
                <table class="table">
                    <thead>
                        <tr>
