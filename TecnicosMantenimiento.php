    ...
    <div class="mainHome">
        <div class="lado1">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="TecnicosMantenimiento.php" class="active">Tecnicos de mantenimiento</a></li>
        ...
        <div class="lado2">
            ...
            <div class="container-texto">
                <p class="titulo1">Tecnicos autorizados para el mantenimiento de maquinaria</p>
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Maquina a reparar</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
